...
public class MWSUser {
	...
	public String toString() {
		return "MWSUser [userId=" + userId + ", email=" + email
				+ ", previousEmail=" + previousEmail + ", password=" + password
				+ ", siteName=" + siteName + ", status=" + status
				+ ", unsuccessfulAttempts=" + unsuccessfulAttempts
				+ ", deleteFlag=" + deleteFlag + ", descFlag=" + descFlag
				+ ", jsonData=" + jsonData + ", registerDate=" + registerDate
