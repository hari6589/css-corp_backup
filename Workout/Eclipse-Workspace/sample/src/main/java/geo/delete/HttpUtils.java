...
import geo.delete.HttpConstants.ContentType;
import geo.delete.HttpConstants.MessageCharset;
...
public class HttpUtils {
	 ...
	 */
	public static HttpResponse post(String url, String message, Map<String, String> headerParams) throws HttpException {
	 ...
	 * @return {@link HttpResponse}
	 */
	public static HttpResponse post(String url, String message, ContentType messageMimeType, MessageCharset messageCharset, Map<String, String> headerParams) throws HttpException {
...
//			HttpClient httpclient = new DefaultHttpClient(ccm);
	        ...
	        httpResponse = (HttpResponse) new geo.delete.HttpResponse(response.getStatusLine().getStatusCode(), responseBody);
	...
	public static geo.delete.HttpResponse get(String uri, Map<String, String> headerParams) throws HttpException {

		geo.delete.HttpResponse httpResponse = null;
		HttpClient httpclient = new DefaultHttpClient();
		String responseBody = "";
		...
		try {
	        ...
	        responseBody = StringUtils.trimToEmpty(responseBody);
	        httpResponse = new geo.delete.HttpResponse(response.getStatusLine().getStatusCode(), responseBody);
