...
public class GoogleGeoCodeService {
	...
	public static void main(String[] args) {
		...
		geoAddress.setAddress("85308");
		Map<StationPrices.Params, Object> map = new HashMap<StationPrices.Params, Object>();
		geoLatLong = geocode(geoAddress, map);
	}

	public static GeoLatLong geocode(GeoAddress geoAddress, Map<StationPrices.Params, Object> params) {
		...
		try {		
			...
			//if (logger.isLoggable(Level.SEVERE)) {
				System.out.println("Failed to create and sign Google API URL: "+url);
			//}
		...
		try {		
			//if (logger.isLoggable(Level.INFO)) {
				System.out.println("Google Geocoding API (v"+GOOGLE_GEOCODE_API_VERSION+"): "+signedUrl);
			//}
			response = geo.delete.HttpUtils.get(signedUrl, null);
		} catch(Throwable ex) {
	 ...
	 */
	private static GeoLatLong parse(String response, String url, String signedUrl) throws JSONException {
		GeoLatLong geoLatLong = new GeoLatLong();
		String country="";
		String statusCode="";
	...
	private static String generateGetGoogleGeoDataLogOutput(Throwable throwable, String subject, String url, String signedUrl, String response) {
   ...
   private static boolean isValidZipCode(String str) {
