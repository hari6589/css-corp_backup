...
public class SESSample {
    ...
    static final String SMTP_USERNAME = "AKIAJPSVSAFEAL2UO57A";  // Replace with your SMTP username.
    static final String SMTP_PASSWORD = "AnHYx+Znh5RYG2F02SJjvG0aTdqXEYHk03vUge/4gr7V";  // Replace with your SMTP password.
    ...
    public static void main(String[] args) throws Exception {
        ...
        try
        {
            ...
            msg.setReplyTo(InternetAddress.parse("hari6589@gmail.com"));
