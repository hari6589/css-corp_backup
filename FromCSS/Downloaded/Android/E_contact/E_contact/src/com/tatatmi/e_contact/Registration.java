...
public class Registration extends Activity implements OnClickListener {
	...
	public static EditText name, phonenumber, address, emergency_name,
			emergency_number;
	...
	Pattern vaddr = Pattern.compile("[A-Za-z]+|[A-Za-z]+\\s[A-Za-z]+");
	...
	public void save() {
		...
		Preferences.writeString(this, Preferences.HOMEADDRESS, address
				.getText().toString());
		Preferences.writeString(this, Preferences.BLOOD_TYPE,
	...
	public boolean validator() {
		...
		if (address.getText().toString() != null) {
			...
			addr = true;
			/*
			 * if (maddr.matches()) { addr = true;
			 * address.setTextColor(Color.BLACK);
			 * faddress.setVisibility(TextView.INVISIBLE); } else { addr =
			 * false; Log.v("VALIDATIONS", "INVALID ADDRESS");
